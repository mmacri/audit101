        ...
        <div className="container max-w-4xl">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-navy mb-3">
              SOX ITGC for IT Practitioners & Admins
            </h1>
            <p className="text-xl text-muted-foreground">
              Your 7-step path to implementing ITGC controls for financial systems
            </p>
          </div>
          <PageIntro>
            This is your main training home for the IT Practitioners & Admins role. Learn how to implement logical access, change management, and computer operations controls for SOX compliance.
          </PageIntro>
        </div>
      </div>
      ...
      <div className="border-b bg-muted/30">
        <div className="container max-w-4xl py-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {soxItgcPractitionersSteps.map((step) => (
