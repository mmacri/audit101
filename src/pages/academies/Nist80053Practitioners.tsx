        ...
        <div className="container max-w-4xl">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-navy mb-3">
              NIST 800-53 for Practitioners & Implementers
            </h1>
            <p className="text-xl text-muted-foreground">
              Your 7-step path to implementing and maintaining NIST 800-53 controls
            </p>
          </div>

          <PageIntro>
            This is your main training home for the Practitioners & Implementers role. Follow the phases, complete the steps, and use the templates to build audit-ready NIST 800-53 control implementations.
          </PageIntro>
        </div>
      </div>
      ...
      <div className="border-b bg-muted/30">
        <div className="container max-w-4xl py-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {nist80053PractitionersSteps.map((step) => (
              <a
                key={step.number}
        ...
        <div className="container max-w-4xl py-8">
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              <Button
                onClick={() => navigate('/common-controls')}
              >
