        ...
        <div className="container max-w-4xl">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-navy mb-3">
              SOX ITGC for Finance & IT Leadership
            </h1>
            <p className="text-xl text-muted-foreground">
              Your 7-step path to governing and overseeing your SOX ITGC program
            </p>
          </div>
          <PageIntro>
            This is your main training home for the Finance & IT Leadership role. Learn how to establish governance, allocate resources, monitor control health, and coordinate with external auditors.
          </PageIntro>
        </div>
      </div>
