        ...
        <div className="container max-w-4xl">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-navy mb-3">
              NIST 800-53 for Internal Auditors & Reviewers
            </h1>
            <p className="text-xl text-muted-foreground">
              Your 7-step path to assessing NIST 800-53 control implementation and effectiveness
            </p>
          </div>

          <PageIntro>
            This is your main training home for the Internal Auditors & Reviewers role. Learn how to plan assessments, test controls, document findings, and support continuous improvement of NIST 800-53 compliance.
          </PageIntro>
        </div>
      </div>
      ...
      <div className="border-b bg-muted/30">
        <div className="container max-w-4xl py-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {nist80053AuditorsSteps.map((step) => (
              <a
                key={step.number}
