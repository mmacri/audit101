        ...
        <div className="container max-w-4xl">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-navy mb-3">
              CIS Controls for Practitioners & Implementers
            </h1>
            <p className="text-xl text-muted-foreground">
              Your 7-step path to implementing the 18 CIS Controls
            </p>
          </div>
          <PageIntro>
            This is your main training home for the Practitioners & Implementers role. Follow the steps to implement CIS Controls across asset management, data protection, vulnerability management, and incident response.
          </PageIntro>
        </div>
      </div>
      ...
      <div className="border-b bg-muted/30">
        <div className="container max-w-4xl py-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {cisControlsPractitionersSteps.map((step) => (
