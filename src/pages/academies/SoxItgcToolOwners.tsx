        ...
        <div className="container max-w-4xl">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-navy mb-3">
              SOX ITGC for System & Tool Owners
            </h1>
            <p className="text-xl text-muted-foreground">
              Your 7-step path to configuring tools for SOX ITGC compliance
            </p>
          </div>
          <PageIntro>
            This is your main training home for the System & Tool Owners role. Learn how to configure IAM, ITSM, backup, and monitoring tools to support SOX ITGC controls and generate audit evidence.
          </PageIntro>
        </div>
      </div>
      ...
      <div className="border-b bg-muted/30">
        <div className="container max-w-4xl py-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {soxItgcToolOwnersSteps.map((step) => (
